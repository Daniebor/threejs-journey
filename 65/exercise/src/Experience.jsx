...
import { CylinderCollider, CuboidCollider, RigidBody, Physics, InstancedRigidBodies } from '@react-three/rapier'
...
export default function Experience()
{
    ...
    const cubeJump = () =>
    {
        cubeRef.current.applyImpulse({x: 0, y: 5 * cubeRef.current.mass(), z: 0})
